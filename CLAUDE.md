...
- Retain Remotion's Chromium OpenGL default unless evidence requires an
  adapter-local `rendering.chromiumOpenGlRenderer` setting. Never force a
  backend globally; document the choice and rerun both strict pixel gates.
